/**
 * Deploy AttesterRegistry Contract using ethers.js directly (Secure Version)
 *
 ...
 *
 * Usage:
 *   npx ts-node scripts/public/deploy-attester-registry-evm-secure.ts [--network base|bsc|both]
 */
...
const ATTESTER_REGISTRY_ABI = [
  ...
  "function enabledAttesterCount() external view returns (uint32)",
...
const CONFIG = {
  // Funding private key from environment variable
  ...
  // Load attesters from external configuration
  attesters: [
    { id: 1, name: 'Director-1', address: process.env.DIRECTOR_1_ADDRESS || '0xA12d48dB2589cfe7ff11a595b80013CffFf5eE3d' },
    { id: 2, name: 'Director-2', address: process.env.DIRECTOR_2_ADDRESS || '0x18a6034995CC0c6Db7fC9Ee53E535f5b1984f83e' },
    { id: 3, name: 'Director-3', address: process.env.DIRECTOR_3_ADDRESS || '0x574B03172d7e637e2aA645eA9789Fe1E36DdBE33' },
    { id: 4, name: 'Director-4', address: process.env.DIRECTOR_4_ADDRESS || '0x698AEdAd3550e716eDA5C923950caC3aA163883F' },
    { id: 5, name: 'Director-5', address: process.env.DIRECTOR_5_ADDRESS || '0xa27f49Bf5a5daa961fECF86526bDa0FD315bE988' },
    { id: 6, name: 'Director-6', address: process.env.DIRECTOR_6_ADDRESS || '0x6250F01Ca6fcCeB81a1c7E5c2f8A114511188934' },
    { id: 7, name: 'Director-7', address: process.env.DIRECTOR_7_ADDRESS || '0x56824F247Bbb54c353025306E860E8edA8877c7b' },
    { id: 8, name: 'Director-8', address: process.env.DIRECTOR_8_ADDRESS || '0x64810209643c663D0505806e66Fe5dc0C5cEdB37' },
    { id: 9, name: 'Director-9', address: process.env.DIRECTOR_9_ADDRESS || '0x3D9f108A558f9DDDc3c0881d6eafF7292d64dF92' },
  ],

  threshold: parseInt(process.env.ATTESTER_THRESHOLD || '5', 10),
  totalAttesters: 9,
};

// Validate required environment variables
if (!CONFIG.fundingKey) {
  console.error('ERROR: FUNDING_PRIVATE_KEY environment variable is not set');
  console.error('Please set FUNDING_PRIVATE_KEY with your funding account private key');
  process.exit(1);
}
...
async function main() {
  ...
  log(colors.blue, '═══════════════════════════════════════════════════════════');
  log(colors.blue, '   ËTRID Attester EVM Funding Script (Secure Version)');
  log(colors.blue, '═══════════════════════════════════════════════════════════');
